...
//		int count = employeeRepository.getAverageSalaryByDepartmentId(id);
//		Double salary = employeeRepository.getSalaryByDepartmentId(id);
//		Double avg_salary = salary/count;
//		
