...
public interface EmployeeRepository extends JpaRepository<Employee,Long> {
	...
	@Query("SELECT COUNT(e) FROM Employee e WHERE e.post = :post")
	Double getAverageSalary(@Param("post")int position);

//	@Transactional
//	@Modifying
//	@Query("SELECT COUNT(e) FROM Employee e WHERE e.department = :department_id")
//	int getAverageSalaryByDepartmentId(@Param("department_id") Long departmentId);
	@Transactional
	@Modifying
